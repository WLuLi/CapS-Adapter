...
# Adapted from https://github.com/vishaal27/SuS-X
...
def hparam_search(val_features, val_labels, test_features, test_labels, train_images_features_agg, train_images_targets, zeroshot_weights, val_kl_divs_sim, test_kl_divs_sim):
    ...
    for alpha in tqdm(alpha_list, desc="Alpha Progress"):
        for beta in beta_list:
            ...
            for b in range(num_batches):
                ...
                new_knowledge = val_features_batch @ train_images_features_agg
    ...
    for b in range(num_batches):
        ...
        new_knowledge = test_features_batch @ train_images_features_agg
