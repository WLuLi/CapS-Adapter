# pure caption similarity baseline
...
test_features_path = features_path + f"/{dataset}_f_test_caption_m{disp_name}.pt"
test_targets_path = features_path + f"/{dataset}_t_test_caption_m{disp_name}.pt"

test_features = torch.load(test_features_path)
test_labels = torch.load(test_targets_path)

text_classifier_weights_path = os.path.join(features_path, f"{dataset}_zeroshot_text_weights_m{disp_name}_ptensemble.pt")
